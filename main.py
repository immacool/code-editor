...
class CustomEditor(QsciScintilla):
    def __init__(self, *args, key_press_handler=None, **kwargs):
        ...
        self.setAutoCompletionUseSingle(QsciScintilla.AutoCompletionUseSingle.AcusAlways);
...
class CustomMainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        """
        if self.editor.unsaved_changes and not self.is_new_file:
